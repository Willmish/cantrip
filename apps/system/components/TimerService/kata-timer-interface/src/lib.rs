...
/// Returns a TimerId bitmask of timers registered with kata_timer_oneshot
/// and kata_timer_periodic that have expired.
#[inline]
pub fn kata_timer_completed_timers() -> Result<TimerMask, TimerServiceError> {
    extern "C" {
...
/// Clients can synchronously wait for this notification using kata_timer_wait.
#[inline]
pub fn kata_timer_oneshot(
    timer_id: TimerId,
...
/// kata_timer_wait. To stop the timer (and notifications) kata_timer_cancel
/// should be called.
#[inline]
pub fn kata_timer_periodic(
    timer_id: TimerId,
    duration_in_ms: TimerDuration,
) -> Result<(), TimerServiceError> {
    extern "C" {
...
#[inline]
pub fn kata_timer_cancel(timer_id: TimerId) -> Result<(), TimerServiceError> {
    extern "C" {
...
#[inline]
pub fn kata_timer_notification() -> seL4_CPtr {
    extern "C" {
...
#[inline]
pub fn kata_timer_wait() -> Result<TimerMask, TimerServiceError> {
    unsafe {
        seL4_Wait(kata_timer_notification(), core::ptr::null_mut());
    }
    kata_timer_completed_timers()
}

/// Returns a bitmask of completed timers. Note this is non-blocking; to
/// wait for one or more timers to complete use kata_timer_wait.
#[inline]
pub fn kata_timer_poll() -> Result<TimerMask, TimerServiceError> {
    unsafe {
        seL4_NBWait(kata_timer_notification(), core::ptr::null_mut());
    }
    kata_timer_completed_timers()
}
...
#[inline]
pub fn kata_timer_capscan() -> Result<(), TimerServiceError> {
    extern "C" {
        fn timer_capscan();
    }
